...
COPY Airline (
	...
	country,
	hub)
FROM '/Users/lengzhang/MyWorkSpace/2017Fall_CS166/FinalProject/code/data/airline.csv'
WITH DELIMITER ',';
--SELECT * FROM Airline;
...
COPY Passenger (
	...
	bdate,
	country)
FROM '/Users/lengzhang/MyWorkSpace/2017Fall_CS166/FinalProject/code/data/passenger.csv'
WITH DELIMITER ',';
...
COPY Flight (
	...
	seats,
	duration)
FROM '/Users/lengzhang/MyWorkSpace/2017Fall_CS166/FinalProject/code/data/flights.csv'
WITH DELIMITER ',';
--SELECT * FROM Flight;
...
COPY Ratings (
	...
	score,
	comment)
FROM '/Users/lengzhang/MyWorkSpace/2017Fall_CS166/FinalProject/code/data/ratings.csv'
WITH DELIMITER ',';
--SELECT * FROM Ratings;
...
COPY Booking (
	...
	flightNum,
	pID)
FROM '/Users/lengzhang/MyWorkSpace/2017Fall_CS166/FinalProject/code/data/bookings.csv'
WITH DELIMITER ',';
--SELECT * FROM Booking;
